...
export const aboutContent = {
  es: {
    ...
    seo: {
      ...
      description: 'Head of Applied AI. Creador de Career-Ops (30K+ ⭐ en GitHub). Construye sistemas IA en producción. Fundador de Santifer iRepair (30.000+ reparaciones, exit 2025).',
    },
  ...
  en: {
    ...
    seo: {
      title: 'Santiago Fernández de Valderrama | Head of Applied AI · Builder of Career-Ops',
      description: 'Head of Applied AI. Creator of Career-Ops (30K+ ⭐ on GitHub). Builds production AI systems. Founded Santifer iRepair (30,000+ repairs, exit 2025).',
    },
    heading: 'Santiago Fernández de Valderrama',
    subtitle: 'Founder · Head of Applied AI · Builder of Career-Ops',
